defmodule F1GridWatcherWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(F1GridWatcherWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(F1GridWatcherWeb.Gettext, "errors", msg, opts)
    end
  end
