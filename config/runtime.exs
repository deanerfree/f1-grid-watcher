...
#
#     PHX_SERVER=true bin/f1_grid_watcher start
#
...
if config_env() == :prod do
  ...
  config :f1_grid_watcher, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :f1_grid_watcher, F1GridWatcher.Mailer,
